		...
		<div className={styles.container}>
			...
			<main>
				<section className={styles.hero}>
					<div data-aos="fade-down" className={`wrapper ${styles.hero_wrapper}`}>
						<h1>
				...
				<section className={styles.ducky_go_go}>
					<div data-aos="fade-down" className={`wrapper ${styles.section_wrapper}`}>
					...
					<section className={styles.our_flow}>
						<div className={`wrapper ${styles.section_wrapper}`}>
							...
							<div className={styles.flow_wrapper}>
								...
								<Image src={"/svg/our-flow-connector.svg"} width={56} height={24} />
								<div className={styles.flow}>
									<p>Choose Network</p>
								</div>
								<Image src={"/svg/our-flow-connector.svg"} width={56} height={24} />
